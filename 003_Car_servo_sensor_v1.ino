...
int pos=0; //create a variable that can be adjusted to be the angle of the servo 0-180 only.
...
void forward(){
  if (distance>15){ //while distance is >15cm, the car will continue moving forward
